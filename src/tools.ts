...
export const tools = {
  generateDiagram: tool({
    description:
      "Generate a complete diagram as an array of Excalidraw elements.  Use this when user asks you to create, draw or design a new diagram. Return all elements needed including shapes, text labels and arrow lines connecting them",
  ...
  modifyDiagram: tool({
    description:
      "Modify an existing element on the canvas by id. Set only the fields you want to change, leave everything else alone",
    inputSchema: z.object({
